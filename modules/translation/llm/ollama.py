...
class OllamaTranslation(CustomTranslation):
    """Translation engine using Ollama's local OpenAI-compatible API."""
    ...
    def initialize(self, settings: Any, source_lang: str, target_lang: str, tr_key: str, **kwargs) -> None:
        ...
        self.api_key = credentials.get('api_key', 'ollama')  # Ollama accepts any key
