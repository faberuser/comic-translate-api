...
```bash
git clone https://github.com/faberuser/comic-translate-api
cd comic-translate
uv init --python 3.12
```
...
Cloud LLMs (API key required — enter your own key in Settings > API Keys):

- GPT-4.1, GPT-4.1-mini (OpenAI)
- Claude-4.6-Sonnet, Claude-4.5-Haiku (Anthropic)
- Gemini-3.0-Flash (Google)
- Deepseek-v3
- Custom (any OpenAI-compatible endpoint)

Local LLMs (no API key needed — model name required):

- **LM Studio** — connects to `http://localhost:1234/v1` by default
